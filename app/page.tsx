    ...
    <main>
      ...
      <header className="site-header">
        <div className="shell nav-wrap">
          ...
          <nav className={`main-nav ${menuOpen ? "open" : ""}`} aria-label="Navegação principal">
            ...
            <a className="nav-button" href={`${whatsapp}?text=${encodeURIComponent("Olá! Vim pelo site da AnaniSign e gostaria de solicitar um orçamento.")}`} target="_blank" rel="noreferrer">Fazer orçamento <span>↗</span></a>
          </nav>
        </div>
      </header>
        ...
        <div className="shell hero-grid">
          <div className="hero-copy reveal">
            ...
            <div className="hero-actions">
              <a className="button button-primary" href={`${whatsapp}?text=${encodeURIComponent("Olá! Quero transformar minha ideia em um projeto com a AnaniSign.")}`} target="_blank" rel="noreferrer">Quero um orçamento <span>↗</span></a>
          ...
          <div className="services-grid">
            {services.map((service) => (
              <article className="service-card reveal" key={service.title}>
                ...
                <a href={`${whatsapp}?text=${encodeURIComponent(`Olá! Gostaria de solicitar um orçamento para ${service.title}.`)}`} target="_blank" rel="noreferrer">Solicitar orçamento <span>↗</span></a>
              </article>
            ))}
          </div>
        </div>
      ...
      <section className="section projects" id="trabalhos">
        <div className="shell">
          <div className="section-heading reveal">
            ...
            <a className="text-link" href="https://www.instagram.com/ananisign/" target="_blank" rel="noreferrer">Ver mais no Instagram <span>↗</span></a>
          </div>
          <div className="projects-grid">
            ...
            <a className="project-callout reveal" href={`${whatsapp}?text=${encodeURIComponent("Olá! Vi os trabalhos da AnaniSign e quero criar meu projeto.")}`} target="_blank" rel="noreferrer">
      ...
      <section className="section testimonials">
        <div className="shell">
          ...
          <a className="google-review reveal" href="https://g.page/r/CfAvt_9BcT90EBM/review" target="_blank" rel="noreferrer">Conte sua experiência no Google <span>↗</span></a>
        </div>
      </section>
        ...
        <div className="shell contact-grid">
          <div className="contact-copy reveal">
            ...
            <div className="contact-details">
              <a href="https://maps.google.com/?q=Av.+Principal,+975,+Ananindeua,+PA" target="_blank" rel="noreferrer"><i>⌖</i><span><small>Visite a gráfica</small>Av. Principal, 975 — Centro<br />Ananindeua — PA</span></a>
              <a href="tel:+5591984838437"><i>◔</i><span><small>Ligue ou chame</small>(91) 98483-8437</span></a>
      ...
      <footer className="footer">
        <div className="shell footer-top">
          ...
          <div className="footer-social"><a href="https://www.instagram.com/ananisign/" target="_blank" rel="noreferrer">Instagram ↗</a><a href="https://www.facebook.com/ananisingimpressaodigital/" target="_blank" rel="noreferrer">Facebook ↗</a></div>
        </div>
      ...
      <a className="whatsapp-float" href={`${whatsapp}?text=${encodeURIComponent("Olá! Vim pelo site e gostaria de solicitar um orçamento.")}`} target="_blank" rel="noreferrer" aria-label="Falar no WhatsApp"><span>◔</span><b>Orçamento rápido</b></a>
    </main>
  );
}
